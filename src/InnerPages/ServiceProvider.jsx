...
const ServiceProvider = () => {
    ...
    useEffect(() => {
        axios.get(`https://sigmainfotechbackend.onrender.com/subser/${subsername}`)
        .then(res => {
         ...
         axios.get(`https://sigmainfotechbackend.onrender.com/serviceprovider/${ sername}/${subsername}`)
        .then(res => {
           setSpdata(res.data);         
